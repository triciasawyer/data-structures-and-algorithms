...
x - Write a function called addTwo
x - that takes in an array and
adds two to every value using a for loop.
...
const typeNum = (arr) => {
  // Solution code here...
  return arr.filter((arrElement) => typeof arrElement === 'number');
};
