...
x -Write a function named getNames
x -that, given an array of people objects,
x -uses map to return an array of names reversed.
...
x -Write a function that appends ' The end.' to a string,
x -and returns the modified string.
x -The original source string should not be modified.
...
x -Write a function that accepts an array
x -and copies the first element to the end of the array.
x -The change should be reflected in the source array that was passed in to the function.
x -That is, the function should modify the array 'in place'.
...
x -Write a function that accepts an objectand an integer as arguments
x -and adds a new property to the object called yearBorn.
x -The value of the yearBorn property should be the integer that was passed in.
