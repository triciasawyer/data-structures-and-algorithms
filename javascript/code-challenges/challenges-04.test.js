...
x -Write a function named updateAnimal
x -that takes in array of animals (strings)
x -and some callback function.

x -This function should first create a new array.
x -Then iterate over the input array
x -and modify each value based on the callback function provided.
...
x -Write a function called sortNames
x -that takes an array of names
x -and sorts them alphabetically.
x -Capital letters should come before lowercase letters.
...
x -Write a function called sortNumbers
...
x -Write a function named sortBackwards
x -that takes in an array of numbers
x -and returns the same array,
...
x -Write a function named alphabetize
...
x -Write a function named sortByPrice
x -that takes in an array of objects,
x -each of which has a 'price' property,
x -and sorts those objects by price, lowest to highest,
