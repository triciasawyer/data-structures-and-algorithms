...
x - Write a function that finds the maximum value in an array
x - using the 'reduce' method.
...
x - Write a function named getCourseKeys
x - that takes in the courseInfo object
x - and returns an array containing the keys for the courseInfo object.
