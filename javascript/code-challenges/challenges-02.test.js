...
x - Write a function named raisedToTheThird
x - that takes in an array of numbers and
returns a new array of each of those numbers raised to the 3rd power (hint: look up Math.pow()).
...
const raisedToTheThird = (arr) => {
  ...
  arr.forEach(arrElement => {
    newArray.push(Math.pow(arrElement, 3));
  });
  return newArray;
};
...
const addOne = (arr) => {
  // Solution code here...
  return arr.map(eleNum => eleNum + 1);
};
...
const addQuestion = (arr) => {
  // Solution code here...
  return arr.map(elementQ => elementQ + '?');
};
...
that produces the same output as your forLoopTwoToThe function from challenge 4,
...
that produces the same output as your forLoopTwoToThe function from challenge 4
and your forEachTwoToThe function from challenge 5,
