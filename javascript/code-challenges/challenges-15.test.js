...
x - Write a function named toTitleCase
x - that takes in an array of strings
x - and returns an array of strings with the first character in upper case and the rest as is.
...
x - Write a function named biggerThanLuke that,
x - given the Star Wars data, below,
x - returns the names of the characters whose mass is greater than Luke's.
